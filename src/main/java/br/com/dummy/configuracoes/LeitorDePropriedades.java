...
public class LeitorDePropriedades {
    ...
    public static String lerPropriedades(String chave) {
        ...
        try (InputStream input = LeitorDePropriedades.class.getClassLoader().getResourceAsStream(caminho)) {
            if (input == null) throw new FileNotFoundException("Arquivo não encontrado: " + caminho);
